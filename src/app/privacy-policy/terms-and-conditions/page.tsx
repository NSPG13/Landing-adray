...
export default function TermsAndConditionsPage() {
    return (
        <section className="pt-32 pb-24">
            <Container>
                <h1 className="t-h2 text-white-90 mb-4">Terms and Conditions</h1>
                ...
                <div className="space-y-10 max-w-3xl">
                    <div>
                        <h2 className="t-h4 text-white-90 mb-3">1. Acceptance of Terms</h2>
                    ...
                    <div>
                        <h2 className="t-h4 text-white-90 mb-3">2. Use of Services</h2>
                        <p className="t-p text-ad-muted leading-relaxed">
                    ...
                    <div>
                        <h2 className="t-h4 text-white-90 mb-3">3. Account Registration</h2>
                        <p className="t-p text-ad-muted leading-relaxed">
                    ...
                    <div>
                        <h2 className="t-h4 text-white-90 mb-3">4. Intellectual Property</h2>
                        <p className="t-p text-ad-muted leading-relaxed">
                    ...
                    <div>
                        <h2 className="t-h4 text-white-90 mb-3">5. Limitation of Liability</h2>
                        <p className="t-p text-ad-muted leading-relaxed">
                    ...
                    <div>
                        <h2 className="t-h4 text-white-90 mb-3">6. Termination</h2>
                        <p className="t-p text-ad-muted leading-relaxed">
                    ...
                    <div>
                        <h2 className="t-h4 text-white-90 mb-3">7. Changes to Terms</h2>
                        <p className="t-p text-ad-muted leading-relaxed">
                    ...
                    <div>
                        <h2 className="t-h4 text-white-90 mb-3">8. Contact</h2>
                        <p className="t-p text-ad-muted leading-relaxed">
