# Adray — Next-gen Enterprise AI Agents
...
| `/ai-solutions` | Product deep-dive, use cases, how it works |
| `/integration` | 200+ tool integrations, API showcase |
...
| `/launching-soon` | Countdown timer + email signup |
...
| Token | Hex | Usage |
|---|---|---|
| `--ad-primary` | `#CA8AE5` | Primary purple |
| `--ad-accent` | `#B55CFF` | Accent / CTA |
| `--ad-deep` | `#3E286F` | Deep purple |
| `--ad-ice` | `#E1D8F3` | Light text |
| `--ad-surface` | `#0F0B14` | Card backgrounds |
| `--ad-black` | `#000000` | Page background |
